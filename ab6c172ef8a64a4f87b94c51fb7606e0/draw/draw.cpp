...
void rysuj_pentro(HDC hdc)
{
	...
	graphics.DrawRectangle(&pen, 5, 5, 200, 450);									//rysowanie szybu windy
	graphics.DrawRectangle(&pen, 205, 5, 200, 150);									//rysowanie piêter
	graphics.DrawRectangle(&pen, 205, 155, 200, 150);									
	graphics.DrawRectangle(&pen, 205, 305, 200, 150);									
}
